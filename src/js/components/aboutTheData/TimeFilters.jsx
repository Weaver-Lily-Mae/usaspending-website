    ...
    useEffect(() => {
        ...
        if (dataAsOf) {
            ...
            if (availablePeriodsInFy.length) {
                ...
                // invalid time selection, use the latest available year and month 👌
                handleTimeChange(`${dataAsOf.year()}`, `${dataAsOf.month()}`);
            }
        }
                ...
                <div className="picker-container">
                    ...
                    <Picker
                        ...
                        selectedOption={selectedPeriod
                            ? getSelectedPeriodTitle(selectedPeriod.title)
                            : (
                                <div className="fy-loading">
...
TimePeriodFilters.propTypes = {
    dataAsOf: PropTypes.oneOfType([PropTypes.object, null]), // moment object or null
    submissionPeriods: PropTypes.oneOfType([PropTypes.arrayOf(PropTypes.object), null]),
    ...
    selectedFy: PropTypes.oneOfType([PropTypes.string, null]),
